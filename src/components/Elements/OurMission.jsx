                            ...
                            <div className="row">
                                <div className="col-md-4 col-sm-6">
                                    <div className="mission-left bg-white m-b30 p-a30 bg-no-repeat bg-bottom-left" style={{ backgroundImage: 'url(' + img3 + ')' }}>
                                        <h3 className="m-t0"><span className="font-weight-100">Mission to serve</span><br /> what we serve</h3>
                                        <p>With professionalism and care, we've welcomed every challenge, resolving them with a smile and delivering exceptional service to our clients.</p>

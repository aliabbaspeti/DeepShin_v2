                                ...
                                <div className="col-md-5 col-sm-6 m-b30">
                                    <div className="our-exp">
                                        <div className="mt-box">
                                            <h3 className="m-t0"><span className="font-weight-100"> We have</span><span className="text-primary"> 15 years</span> experience in Technical Services</h3>
                                        </div>
                                        ...
                                        <span className="progressText text-black"><b>Industry</b></span>
                                        <div className="progress mt-probar-1 m-b30 m-t10">

                                ...
                                <div className="col-md-4 col-sm-12">
                                    ...
                                    <div className="section-head">
                                        <div className="mt-separator-outer separator-left">
                                            ...
                                            <p>Our experienced professionals ensure top-quality service, whether it's cleaning, maintenance, or event management. 
                                                With a focus on simplicity, reliability, and customer satisfaction, we consistently deliver results that exceed expectations.</p>
                                        </div>
                                    </div>
                                    {/* TITLE END */}
                                    <div className="author-info p-t20">
                                        ...
                                        <div className="author-name">
                                            <h4 className="m-t0">Mr Farman</h4>
                                ...
                                <div className="col-md-5 col-sm-6">
                                    <div className="p-b0">
                                        <div className="mt-box">
                                            <h3 className="m-t0"><span className="font-weight-100"> We have</span><span className="text-primary"> 15 years</span> experience in Cleaning & Manpower Services</h3>
                                        </div>
                                        ...
                                        <div className="progress mt-probar-1  m-b30 m-t10">
                                            <div className="progress-bar bg-primary " role="progressbar" aria-valuenow={90} aria-valuemin={0} aria-valuemax={100}>
                                                <span className="popOver" data-toggle="tooltips" data-placement="right" title="90%" />
                                            </div>
                                        </div>
                                        <span className="progressText text-black"><b>Residential</b></span>
                                        <div className="progress mt-probar-1 m-b30 m-t10">
                                            <div className="progress-bar bg-primary" role="progressbar" aria-valuenow={70} aria-valuemin={10} aria-valuemax={100}>
                                                <span className="popOver" data-toggle="tooltips" data-placement="right" title="70%" />
                                            </div>
                                        </div>
                                        <span className="progressText text-black"><b>Industrial</b></span>
                                        <div className="progress mt-probar-1 m-b30 m-t10">
                                            <div className="progress-bar bg-primary" role="progressbar" aria-valuenow={50} aria-valuemin={0} aria-valuemax={100}>
                                                <span className="popOver" data-toggle="tooltips" data-placement="right" title="50%" />
                                            </div>
                                        {/* </div>

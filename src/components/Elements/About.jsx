                            ...
                            <div className="row">
                                ...
                                <div className="col-md-3 col-sm-12">
                                    <div className="about-home-right bg-white p-a30">
                                        <h3 className="m-t0"><span className="font-weight-100">We are committed</span> to providing top-quality cleaning, maintenance, and event management solutions tailored to your every need.</h3>
                                        <p><strong>Our highly experienced team understands the importance of quality and excellence, 
                                        ensuring that every task is completed to the highest standards.
                                        </strong></p>
                                        <p>With a strong focus on customer satisfaction, we take pride in our attention to detail and professionalism.
                                        Whether you require routine maintenance or assistance with a special event,
                                        our skilled professionals are here to deliver outstanding results.
                                        Trust us to enhance your space and make every occasion memorable.</p>

...
const services = [
    ...
    },
    {
        ...
        icon: require('./../../images/icon/renovation.png'),
        image: require('./../../images/services/2.jpg'),
        description: 'Our solutions help businesses maintain seamless production schedules while accessing skilled and experienced professionals for specific roles.',
    },
    {
        count: 5,
